...
struct Pnt3 {
	...
	// Subtract two points and get a vector that represents the displacement between them. Creates a new point and returns it. 
...
// Represents a ray that shoots out into space in a straight line from some origin point. 
struct Ray {
	Pnt3 origin;
	Vec3 direction;
...
public:
	...
	// Construct an affine matrix from a 3x3 transformation matrix and a translation vector. 
